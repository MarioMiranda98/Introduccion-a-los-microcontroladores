...
; 0000 0025 DDRA=(0<<DDA7) | (0<<DDA6) | (0<<DDA5) | (0<<DDA4) | (0<<DDA3) | (0<<DDA2) | (0<<DDA1) | (0<<DDA0);
	LDI  R30,LOW(0)
	OUT  0x1A,R30
; 0000 0026 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=T Bit2=T Bit1=T Bit0=P
; 0000 0027 PORTA=(0<<PORTA7) | (0<<PORTA6) | (0<<PORTA5) | (0<<PORTA4) | (0<<PORTA3) | (0<<PORTA2) | (0<<PORTA1) | (1<<PORTA0);
	LDI  R30,LOW(1)
	OUT  0x1B,R30
; 0000 0028 
...
; 0000 008D             PORTC.0=1;
	RCALL SUBOPT_0x0
; 0000 008E             PORTC.1=1;
; 0000 008F             delay_us(2350);
	RCALL SUBOPT_0x1
; 0000 0090             PORTC.0=0;
	CBI  0x15,0
; 0000 0091             delay_us(2350);
	RCALL SUBOPT_0x1
; 0000 0092 
; 0000 0093       }
; 0000 0094       else if(boton2==0){
	RJMP _0xD
_0x6:
	SBIC 0x16,1
	RJMP _0xE
...
; 0000 0096             PORTC.0=1;
	RCALL SUBOPT_0x0
; 0000 0097             PORTC.1=1;
; 0000 0098             delay_us(620);
	__DELAY_USB 207
; 0000 0099             PORTC.0=0;
	CBI  0x15,0
; 0000 009A             delay_us(620);
	__DELAY_USB 207
; 0000 009B 
; 0000 009C       }
; 0000 009D       else if(boton3==0){
	RJMP _0x15
_0xE:
	SBIC 0x16,2
	RJMP _0x16
...
; 0000 009F             PORTC.0=1;
	RCALL SUBOPT_0x0
; 0000 00A0             PORTC.1=1;
; 0000 00A1             delay_us(185);
	__DELAY_USB 62
; 0000 00A2             PORTC.0=0;
	CBI  0x15,0
; 0000 00A3             delay_us(185);
	__DELAY_USB 62
; 0000 00A4 
; 0000 00A5 
; 0000 00A6       }
; 0000 00A7       else if(boton4==0){
	RJMP _0x1D
_0x16:
	SBIC 0x16,3
	RJMP _0x1E
...
; 0000 00A9             PORTC.0=1;
	RCALL SUBOPT_0x0
; 0000 00AA             PORTC.1=1;
; 0000 00AB             delay_us(85);
	__DELAY_USB 28
; 0000 00AC             PORTC.0=0;
	CBI  0x15,0
; 0000 00AD             delay_us(85);
	__DELAY_USB 28
; 0000 00AE 
; 0000 00AF 
; 0000 00B0       }else{
