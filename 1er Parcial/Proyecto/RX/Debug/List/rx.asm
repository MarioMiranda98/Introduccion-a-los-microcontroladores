...
; 0000 008E         if(presionado==1){
	SBIS 0x16,1
	RJMP _0x6
; 0000 008F 
; 0000 0090         if (boton==0){
	SBIC 0x16,0
	RJMP _0x7
; 0000 0091             botona=0;
	CLT
...
; 0000 0094         }
; 0000 0095 
; 0000 0096         if ((botonp==0)&&(botona==1)){ //hubo cambio de flanco de 0 a 1
	SBRC R2,0
	RJMP _0xA
	SBRC R2,1
	RJMP _0xB
...
; 0000 0097             var++;
	...
	ADIW R30,1
	MOVW R4,R30
; 0000 0098         } //Se incrementa la variable
; 0000 0099         botonp=botona;
_0x9:
	BST  R2,1
	BLD  R2,0
; 0000 009A 
...
; 0000 00A2             PORTC=0x01;
	LDI  R30,LOW(1)
	RCALL SUBOPT_0x2
; 0000 00A3             delay_ms(80);
; 0000 00A4             PORTC=0x00;
; 0000 00A5         }if(var>27 && var<=75){
_0xD:
	RCALL SUBOPT_0x1
	BRGE _0x11
	RCALL SUBOPT_0x3
...
_0x11:
	RJMP _0x10
_0x12:
; 0000 00A6             PORTC=0x02;
	LDI  R30,LOW(2)
	RCALL SUBOPT_0x2
; 0000 00A7             delay_ms(80);
; 0000 00A8             PORTC=0x00;
; 0000 00A9         }if(var>75 && var<=200){
_0x10:
	RCALL SUBOPT_0x3
	BRGE _0x14
	RCALL SUBOPT_0x4
...
_0x14:
	RJMP _0x13
_0x15:
; 0000 00AA             PORTC=0x04;
	LDI  R30,LOW(4)
	RCALL SUBOPT_0x2
; 0000 00AB             delay_ms(80);
; 0000 00AC             PORTC=0x00;
; 0000 00AD         }if(var>200 && var<=430) {
_0x13:
	RCALL SUBOPT_0x4
	BRGE _0x17
	LDI  R30,LOW(430)
...
_0x17:
	RJMP _0x16
_0x18:
; 0000 00AE             PORTC=0x08;
	LDI  R30,LOW(8)
	RCALL SUBOPT_0x2
; 0000 00AF             delay_ms(80);
