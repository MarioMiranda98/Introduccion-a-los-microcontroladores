...
; 0000 0045 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
; 0000 0046 // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 0047 PORTD=(1<<PORTD7) | (1<<PORTD6) | (1<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(255)
	OUT  0x12,R30
; 0000 0048 
...
_0xE:
	BLD  R2,1
; 0000 009D 
; 0000 009E       if((botona == 0) && (botonp == 1))
	SBRC R2,1
	RJMP _0xA
	SBRC R2,0
	RJMP _0xB
...
; 0000 00A1         var1 = 0;
	LDI  R17,LOW(0)
; 0000 00A2 
; 0000 00A3       PORTB = tabla7Segmentos[var1];
_0xC:
	MOV  R30,R17
	LDI  R31,0
	MOVW R26,R28
