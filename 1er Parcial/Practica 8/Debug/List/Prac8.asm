...
;#define reset PIND.0
;int i;
;unsigned char var=0, var1=0, var2=0;
...
; 0000 0090       var2=0;
; 0000 0091       i=0;
; 0000 0092       PORTC=~tabla7segmentos[var];
	LPM  R30,Z
	COM  R30
	OUT  0x15,R30
; 0000 0093       PORTA=~tabla7segmentos[var1];
	RCALL SUBOPT_0x1
	RCALL SUBOPT_0x2
	OUT  0x1B,R30
; 0000 0094       PORTB=~tabla7segmentos[var2];
	RCALL SUBOPT_0x3
	RCALL SUBOPT_0x2
	OUT  0x18,R30
; 0000 0095       }
; 0000 0096 
; 0000 0097       if(start==0){
_0x6:
	SBIC 0x10,2
	RJMP _0x7
; 0000 0098       for(i=0; i<=600; i++){
	CLR  R4
	CLR  R5
_0x9:
	LDI  R30,LOW(600)
...
; 0000 00AE       l=var2;
	...
	ST   Y,R30
	STD  Y+1,R31
; 0000 00AF       PORTC=tabla7segmentos[j];
	LDD  R30,Y+4
	LDD  R31,Y+4+1
	RCALL SUBOPT_0x4
	OUT  0x15,R0
; 0000 00B0       PORTA=tabla7segmentos[k];
	LDD  R30,Y+2
	LDD  R31,Y+2+1
	RCALL SUBOPT_0x4
	OUT  0x1B,R0
; 0000 00B1       PORTB=tabla7segmentos[l];
	LD   R30,Y
	LDD  R31,Y+1
	RCALL SUBOPT_0x4
	OUT  0x18,R0
...
; 0000 00B9       var2=0;
; 0000 00BA       i=0;
; 0000 00BB       PORTC=tabla7segmentos[var];
	LPM  R0,Z
	OUT  0x15,R0
; 0000 00BC       PORTA=tabla7segmentos[var1];
	RCALL SUBOPT_0x1
	RCALL SUBOPT_0x4
	OUT  0x1B,R0
; 0000 00BD       PORTB=tabla7segmentos[var2];
	RCALL SUBOPT_0x3
	RCALL SUBOPT_0x4
	OUT  0x18,R0
; 0000 00BE       break;
...
_0xF:
	...
	LDI  R27,0
	RCALL _delay_ms
; 0000 00C2       PORTC=tabla7segmentos[var];
	MOV  R30,R7
	LDI  R31,0
	RCALL SUBOPT_0x4
	OUT  0x15,R0
; 0000 00C3       PORTA=tabla7segmentos[var1];
	RCALL SUBOPT_0x1
	RCALL SUBOPT_0x4
	OUT  0x1B,R0
; 0000 00C4       PORTB=tabla7segmentos[var2];
	RCALL SUBOPT_0x3
	RCALL SUBOPT_0x4
	OUT  0x18,R0
; 0000 00C5       }
