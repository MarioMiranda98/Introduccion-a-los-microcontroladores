...
_0x11:
	BLD  R2,0
; 0000 009D 
; 0000 009E         if((botonp == 1) && (botona == 0)) {
	SBRS R2,1
	RJMP _0xA
	SBRS R2,0
	RJMP _0xB
...
; 0000 009F             var1++;
	SUBI R17,-1
; 0000 00A0 
; 0000 00A1             if(var1 >= 10)
	CPI  R17,10
	BRLO _0xC
; 0000 00A2                 var1 = 0;
	LDI  R17,LOW(0)
; 0000 00A3 
; 0000 00A4             delay_ms(40);
_0xC:
	LDI  R26,LOW(40)
	LDI  R27,0
	RCALL _delay_ms
; 0000 00A5         }
; 0000 00A6 
; 0000 00A7         if((botonp == 0) && (botona == 1))
_0x9:
	SBRC R2,1
	RJMP _0xE
	SBRC R2,0
...
; 0000 00A8             delay_ms(40);
	...
	RCALL _delay_ms
; 0000 00A9 
; 0000 00AA         PORTB = tabla7Segmentos[var1];
_0xD:
	MOV  R30,R17
	LDI  R31,0
	MOVW R26,R28
