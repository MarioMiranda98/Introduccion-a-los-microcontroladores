...
; 0000 001F const char tabla7Segmentos[10] = {
; 0000 0020     0x3f,
; 0000 0021     0x06,
; 0000 0022     0x5b,
; 0000 0023     0x4f,
...
; 0000 0043 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x11,R30
; 0000 0044 // State: Bit7=P Bit6=P Bit5=P Bit4=P Bit3=P Bit2=P Bit1=P Bit0=P
; 0000 0045 PORTD=(1<<PORTD7) | (1<<PORTD6) | (1<<PORTD5) | (1<<PORTD4) | (1<<PORTD3) | (1<<PORTD2) | (1<<PORTD1) | (1<<PORTD0);
	LDI  R30,LOW(255)
	OUT  0x12,R30
; 0000 0046 
...
; 0000 0097         if(boton == 0)
	SBIS 0x10,0
; 0000 0098             var1++;
	SUBI R17,-1
; 0000 0099 
; 0000 009A         if(var1 == 10)
	CPI  R17,10
	BRNE _0x8
; 0000 009B             var1 = 0;
	LDI  R17,LOW(0)
; 0000 009C 
; 0000 009D         PORTB = tabla7Segmentos[var1];
_0x8:
	MOV  R30,R17
	LDI  R31,0
	MOVW R26,R28
