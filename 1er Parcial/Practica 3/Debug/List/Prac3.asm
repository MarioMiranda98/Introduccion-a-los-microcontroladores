...
; 0000 001E unsigned char variable;
; 0000 001F unsigned char variable2;
; 0000 0020 const char tabla7Segmentos[10] = {
; 0000 0021     0x3f,
; 0000 0022     0x06,
; 0000 0023     0x5b,
; 0000 0024     0x4f,
...
; 0000 003D PORTC=(1<<PORTC7) | (1<<PORTC6) | (1<<PORTC5) | (1<<PORTC4) | (1<<PORTC3) | (1<<PORTC2) | (1<<PORTC1) | (1<<PORTC0);
	LDI  R30,LOW(255)
	OUT  0x15,R30
; 0000 003E 
...
; 0000 0095         variable = PIND & 0x0f;
	IN   R30,0x10
	ANDI R30,LOW(0xF)
	MOV  R17,R30
; 0000 0096         variable2 = PINC & 0x0f;
	IN   R30,0x13
	ANDI R30,LOW(0xF)
	MOV  R16,R30
; 0000 0097 
; 0000 0098         if(variable < 10) {
	CPI  R17,10
	BRSH _0x7
; 0000 0099             PORTB = tabla7Segmentos[variable];
	MOV  R30,R17
	RCALL SUBOPT_0x0
	OUT  0x18,R30
; 0000 009A             PORTA = ~(tabla7Segmentos[variable2]);
	MOV  R30,R16
	RCALL SUBOPT_0x0
	COM  R30
	OUT  0x1B,R30
; 0000 009B         }
; 0000 009C 
; 0000 009D         if(variable >= 10) {
_0x7:
	CPI  R17,10
	BRLO _0x8
; 0000 009E             PORTB = 0x79;
	LDI  R30,LOW(121)
	OUT  0x18,R30
; 0000 009F             PORTA = ~(0x79);
	LDI  R30,LOW(134)
	OUT  0x1B,R30
; 0000 00A0         }
; 0000 00A1 }
