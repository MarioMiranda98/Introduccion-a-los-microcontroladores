...
; 0000 0021 const char tabla7Segmentos[10] = {
; 0000 0022     0x3f,
; 0000 0023     0x06,
; 0000 0024     0x5b,
; 0000 0025     0x4f,
...
; 0000 002C };
; 0000 002D 
; 0000 002E unsigned char var1;
; 0000 002F unsigned char var2;
; 0000 0030 var1 = 0;
	SBIW R28,10
	LDI  R24,10
	__GETWRN 22,23,0
...
_0x11:
	BLD  R2,0
; 0000 009F 
; 0000 00A0         if((botonp == 1) && (botona == 0)) {
	SBRS R2,1
	RJMP _0xA
	SBRS R2,0
	RJMP _0xB
...
; 0000 00A1             contador++;
	...
	MOVW R4,R30
; 0000 00A2 
; 0000 00A3             if(contador > 99)
	LDI  R30,LOW(99)
	LDI  R31,HIGH(99)
	CP   R30,R4
	CPC  R31,R5
	BRGE _0xC
; 0000 00A4                 contador = 0;
	CLR  R4
	CLR  R5
; 0000 00A5 
; 0000 00A6             delay_ms(40);
_0xC:
	LDI  R26,LOW(40)
	LDI  R27,0
	RCALL _delay_ms
; 0000 00A7         }
; 0000 00A8 
; 0000 00A9         if((botonp == 0) && (botona == 1))
_0x9:
	SBRC R2,1
	RJMP _0xE
	SBRC R2,0
...
_0xD:
	...
	RCALL __DIVW21
	MOV  R17,R30
; 0000 00AD         var2 = contador % 10;
	MOVW R26,R4
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	RCALL __MODW21
	MOV  R16,R30
; 0000 00AE         PORTB = tabla7Segmentos[var1];
	MOV  R30,R17
	RCALL SUBOPT_0x0
	OUT  0x18,R30
; 0000 00AF         PORTA = tabla7Segmentos[var2];
	MOV  R30,R16
	RCALL SUBOPT_0x0
	OUT  0x1B,R30
; 0000 00B0         botonp = botona;
	BST  R2,0
	BLD  R2,1
; 0000 00B1       }
	RJMP _0x4
