...
; 0000 0039 PORTC=(1<<PORTC7) | (1<<PORTC6) | (1<<PORTC5) | (1<<PORTC4) | (1<<PORTC3) | (1<<PORTC2) | (1<<PORTC1) | (1<<PORTC0);
	LDI  R30,LOW(255)
	OUT  0x15,R30
; 0000 003A 
...
; 0000 0066 ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 0067 TCCR2=(0<<WGM20) | (0<<COM21) | (0<<COM20) | (0<<WGM21) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
...
; 0000 0084 ADCSRA=(0<<ADEN) | (0<<ADSC) | (0<<ADATE) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (0<<ADPS1) | (0<<ADPS0);
	OUT  0x6,R30
; 0000 0085 
...
; 0000 008C TWCR=(0<<TWEA) | (0<<TWSTA) | (0<<TWSTO) | (0<<TWEN) | (0<<TWIE);
	OUT  0x36,R30
; 0000 008D 
; 0000 008E if(datoaguardar > 10)
	RCALL SUBOPT_0x0
	RCALL __EEPROMRDB
	CPI  R30,LOW(0xB)
	BRLO _0x3
; 0000 008F     datoaguardar = 0;
	RCALL SUBOPT_0x0
	LDI  R30,LOW(0)
	RCALL __EEPROMWRB
; 0000 0090 var = datoaguardar;
_0x3:
	RCALL SUBOPT_0x0
	RCALL __EEPROMRDB
	MOV  R5,R30
...
; 0000 0095       checa_boton();
	RCALL _checa_boton
; 0000 0096       PORTB=(tabla7segmentos [var]);
	MOV  R30,R5
	LDI  R31,0
	...
	LPM  R0,Z
	OUT  0x18,R0
; 0000 0097       if (boton_guarda==0) //Si se presiona el bot?n de guardar
	SBIC 0x13,1
	RJMP _0x7
; 0000 0098         datoaguardar=var; //se grabara la eeprom con el valor de var
	MOV  R30,R5
	RCALL SUBOPT_0x0
	RCALL __EEPROMWRB
; 0000 0099       }
...
_0x12:
	BLD  R2,1
; 0000 00A2     if ((botonp==1)&&(botona==0)){ //hubo cambio de flanco de 1 a 0
	SBRS R2,0
	RJMP _0xC
	SBRS R2,1
	RJMP _0xD
_0xC:
	RJMP _0xB
_0xD:
; 0000 00A3         var++; //Se incrementa la variable
	INC  R5
; 0000 00A4         if (var>=10)
	LDI  R30,LOW(10)
	CP   R5,R30
...
_0xE:
	...
	RCALL _delay_ms
; 0000 00A7     }
; 0000 00A8     if ((botonp==0)&&(botona==1)) //hubo cambio de flanco de 0 a 1
_0xB:
	SBRC R2,0
	RJMP _0x10
	SBRC R2,1
...
_0x10:
	RJMP _0xF
_0x11:
; 0000 00A9         delay_ms(40); //Se coloca retardo de 40mS para eliminar rebotes
	LDI  R26,LOW(40)
	LDI  R27,0
	RCALL _delay_ms
; 0000 00AA     botonp=botona;
_0xF:
	BST  R2,1
	BLD  R2,0
; 0000 00AB }
...
SUBOPT_0x0:
	LDI  R26,LOW(_datoaguardar)
	LDI  R27,HIGH(_datoaguardar)
	RET
